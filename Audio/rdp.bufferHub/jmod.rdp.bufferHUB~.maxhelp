...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.0, 174.0, 161.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.5, 116.5, 56.0, 20.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 553.5, 439.5, 151.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 553.5, 269.5, 159.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.5, 192.5, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.5, 296.5, 300.0, 140.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 250.0, 384.0, 36.0, 20.0 ],
													"text" : "pack"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 367.0, 302.5, 53.0, 21.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 50.0, 302.5, 53.0, 21.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 50.0, 157.0, 37.0, 21.0 ],
													"text" : "+ 40"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 50.0, 128.0, 72.0, 21.0 ],
													"text" : "random 40"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 50.0, 185.0, 119.0, 21.0 ],
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 50.0, 241.5, 336.0, 53.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 114.0, 300.5, 248.0, 66.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 250.0, 464.0, 25.0, 25.0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"disabled" : 0,
													"hidden" : 0,
													"midpoints" : [ 159.5, 217.5, 376.5, 217.5 ],
													"source" : [ "obj-10", 1 ]
												}
...
,
									"patching_rect" : [ 50.0, 161.5, 43.0, 20.0 ],
...
,
					"patching_rect" : [ 29.0, 203.0, 43.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.5, 366.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 553.5, 89.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 871.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.5, 143.5, 187.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-8",
					"maxclass" : "bpatcher",
					"name" : "jmod.rdp.grain~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 336.5, 277.5, 150.0, 35.0 ],
					"presentation_rect" : [ 419.5, 239.5, 150.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 238.0, 107.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-14",
					"maxclass" : "bpatcher",
					"name" : "jmod.rdp.sampler~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 146.5, 277.5, 150.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"maxclass" : "bpatcher",
					"name" : "jmod.rdp.bufferHUB~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 146.5, 188.0, 150.0, 35.0 ],
					"presentation_rect" : [ 0.0, 0.0, 150.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 146.5, 238.0, 152.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 38.5, 265.0, 156.0, 265.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 156.0, 265.0, 346.0, 265.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 563.0, 462.5, 539.5, 462.5, 539.5, 184.5, 563.0, 184.5 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-14::obj-4::obj-68" : [ "attack", "attack", 0 ],
			"obj-14::obj-4::obj-18" : [ "ducking", "ducking", 0 ],
			"obj-14::obj-4::obj-13" : [ "sustain", "sustain", 0 ],
			"obj-14::obj-4::obj-69" : [ "decay", "decay", 0 ],
			"obj-14::obj-4::obj-12" : [ "release", "release", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "jmod.rdp.bufferHUB~.maxpat",
				"bootpath" : "/Users/rdpozo/JamomaDev/rdp.modules/Audio/rdp.bufferHub",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "jmod.rdp.sampler~.maxpat",
				"bootpath" : "/Users/rdpozo/JamomaDev/rdp.modules/Audio/rdp.sampler",
				"patcherrelativepath" : "../rdp.sampler",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "jmod.rdp.grain~.maxpat",
				"bootpath" : "/Users/rdpozo/JamomaDev/rdp.modules/Audio/rdp.grain",
				"patcherrelativepath" : "../rdp.grain",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "jalg.rdp.grain~.maxpat",
				"bootpath" : "/Users/rdpozo/JamomaDev/rdp.modules/Audio/rdp.grain/lib",
				"patcherrelativepath" : "../rdp.grain/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "jmod.cueTrigger.maxpat",
				"bootpath" : "/Applications/Max6/Cycling '74/Jamoma/modules/control/cueTrigger",
				"patcherrelativepath" : "../../../../../../Applications/Max6/Cycling '74/Jamoma/modules/control/cueTrigger",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
