...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 730.0, 24.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 683.0, 24.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 35.0, 244.0, 302.0, 20.0 ],
					"text" : "jcom.hub @module_type audio @description distortion"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 683.0, 57.0, 66.0, 20.0 ],
					"text" : "jcom.in~ 2"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 166.0, 447.0, 1074.0, 20.0 ],
									"text" : "jcom.parameter distortion @range/bounds -1. 1. @type decimal @range/clipmode both @ramp/drive scheduler @ramp/function linear @dataspace none @priority 1 @description \"Amount of distortion\"",
									"varname" : "distortion"
								}
...
, 							{
								"box" : 								{
									"annotation" : "Amount of distortion",
									...
									"presentation" : 1,
									"presentation_rect" : [ 84.5, 64.369873, 50.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 11.5, 65.369873, 76.0, 18.0 ],
									"text" : "Distortion:",
									"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "A module for distortion of sound",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 2.0, 95.448822, 247.0, 21.0 ],
									"rounded" : 4
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 2.0, 56.369873, 247.0, 37.078949 ],
									"rounded" : 4
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 18.0, 86.0, 18.0 ],
					"text" : "rdp.distortion~",
					"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.rdp.distortion~.maxpat",
				"bootpath" : "/Users/delpozo/Documents/Max/Github_Development_Library/rdpozo_Modules/Audio/rdp.distortion/lib",
