...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.5, 230.5, 56.0, 20.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 330.5, 553.5, 151.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 330.5, 383.5, 159.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.5, 306.5, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.5, 410.5, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 330.5, 203.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 428.0, 300.0, 140.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 340.0, 576.5, 325.5, 576.5, 325.5, 298.5, 340.0, 298.5 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jmod.rdp.grain~.maxpat",
				"bootpath" : "/Users/pozo/rdpozo_Modules/rdp.grain",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"bootpath" : "/Users/pozo/rdpozo_Modules/rdp.grain/lib",
...
, 			{
				...
				"patcherrelativepath" : "../rdp.bufferHub",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
