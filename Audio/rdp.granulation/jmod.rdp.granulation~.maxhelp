...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 104.0, 296.0, 62.0 ],
					"text" : "This module is based on the patch found in the examples folder of Max/MSP.\nI have made some adjustments and added some features for windowing."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 335.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 184.0, 116.0, 18.0 ],
					"text" : "/granulation/time $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 77.0, 116.0, 48.0 ],
					"text" : "Duration can be set with two integers, ranging from 0-127"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 61.0, 127.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 8.0, 127.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 159.0, 48.0, 20.0 ],
					"text" : "pak i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 184.0, 91.0, 18.0 ],
					"text" : "/duration $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "jmod.rdp.granulation~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 307.0, 273.0, 150.0, 35.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.rdp.granulation~", "@description", "A module for granulation of audio files." ],
					"bgmode" : 1,
					"id" : "obj-3",
					"maxclass" : "bpatcher",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 70.5, 152.5, 46.5, 152.5 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"name" : "jmod.rdp.granulation~.maxpat",
				"bootpath" : "/Users/rdpozo/JamomaDev/rdp.modules/Audio/rdp.granulation",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
