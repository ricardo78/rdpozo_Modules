{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 299.0, 88.0, 866.0, 721.0 ],
		"bglocked" : 0,
		"defrect" : [ 299.0, 88.0, 866.0, 721.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, 111.0, 41.0, 18.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.0, 112.0, 37.0, 18.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.0, 521.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 85.0, 58.0, 71.0, 20.0 ],
					"text" : "route dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 167.5, 198.0, 39.0, 20.0 ],
					"text" : "zl rev"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 167.5, 174.0, 61.0, 20.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 167.5, 329.0, 94.0, 20.0 ],
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 167.5, 301.0, 41.0, 20.0 ],
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 167.5, 265.0, 38.0, 20.0 ],
					"text" : "% 16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 216.5, 265.0, 32.5, 20.0 ],
					"text" : "/ 16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 167.5, 221.0, 94.0, 20.0 ],
					"text" : "unpack"
				}
...
,
					"patching_rect" : [ 221.5, 109.0, 53.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 167.0, 146.0, 59.5, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 221.0, 86.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"hidden" : 0,
					"midpoints" : [ 231.0, 139.5, 176.5, 139.5 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 177.0, 251.0, 226.0, 251.0 ],
					"source" : [ "obj-62", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"hidden" : 0,
					"midpoints" : [ 94.5, 132.0, 176.5, 132.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 226.0, 291.5, 199.0, 291.5 ],
					"source" : [ "obj-77", 0 ]
				}
