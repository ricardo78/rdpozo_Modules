...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 65.0, 184.0, 609.0, 47.0 ],
									"text" : "jcom.parameter amount @type decimal @range/bounds 0. 1. @range/clipmode both @repetitions/allow 1 @ramp/drive scheduler @ramp/function linear @dataspace none @priority 1 @description \"the amount of blur applied\"",
									"varname" : "amount[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.5, 231.0, 88.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 3.0, 84.0, 90.0, 18.0 ],
									"text" : "Amount of blur:",
									"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 2.0, 113.0, 247.0, 21.0 ],
									"rounded" : 4
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 10.5, 197.5, 50.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 95.0, 83.0, 50.0, 20.0 ],
									"textcolor" : [ 0.4, 0.4, 0.4, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 2.0, 55.0, 247.0, 57.0 ],
									"rounded" : 4
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 424.0, 106.0, 93.0, 20.0 ],
					"text" : "jalg.gl.blur% #0"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 413.5, 90.5, 507.5, 90.5 ],
					"source" : [ "obj-1", 0 ]
				}
