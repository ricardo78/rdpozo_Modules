...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 525.5, 77.0, 25.0, 25.0 ],
					"presentation_rect" : [ 450.0, 91.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.0, 244.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 343.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 223.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 437.0, 213.0, 66.0, 20.0 ],
					"text" : "jcom.out 1"
				}
...
,
					"patching_rect" : [ 727.833313, 298.0, 79.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 556.333313, 226.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 556.333313, 258.0, 362.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 120.0, 326.0, 259.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.0, 226.0, 130.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 46.0, 272.0, 345.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 222.0, 199.0, 55.0, 20.0 ],
					"text" : "jcom.init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 222.0, 226.0, 110.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 787.833313, 336.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 119.0, 97.0, 18.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 5.0, 107.0, 64.5, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 5.0, 101.0, 64.5, 18.0 ],
									"text" : "Range:",
									"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 121.5, 330.0, 50.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 161.75, 101.0, 50.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 55.5, 330.0, 50.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 111.75, 101.0, 50.0, 20.0 ],
									"textcolor" : [ 0.4, 0.4, 0.4, 1.0 ],
									"tricolor" : [ 0.4, 0.4, 0.4, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 11,
									"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 62.5, 362.0, 154.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 224.0, 340.0, 530.0, 33.0 ],
									"text" : "jcom.parameter range @range/bounds 0. 4000. @type decimalArray @range/clipmode none @repetitions/allow 1 @ramp/drive scheduler @ramp/function linear @dataspace none @priority 2",
									"varname" : "range"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 153.0, 464.0, 579.0, 33.0 ],
									"text" : "jcom.parameter prob @type decimal @range/bounds 0. 1000. @range/clipmode both @repetitions/allow 1 @ramp/drive scheduler @ramp/function linear @dataspace none",
									"varname" : "drawto[1]"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 5.0, 82.0, 64.5, 18.0 ],
									"text" : "Prob:",
									"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 92.0, 464.0, 50.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 111.75, 82.0, 50.0, 20.0 ],
									"textcolor" : [ 0.4, 0.4, 0.4, 1.0 ],
									"tricolor" : [ 0.4, 0.4, 0.4, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 2.0, 122.0, 247.0, 21.0 ],
									"rounded" : 4
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 2.0, 55.0, 247.0, 66.0 ],
									"rounded" : 4
								}
...
,
					"patching_rect" : [ 727.833313, 385.0, 67.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 85.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.0, 77.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 437.0, 174.0, 114.0, 20.0 ],
					"text" : "jalg.gl.pixelate% #0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 485.0, 110.0, 59.5, 20.0 ],
					"text" : "jcom.in 2"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 249.5, 370.0, 737.333313, 370.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 129.5, 370.0, 737.333313, 370.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 95.5, 259.0, 55.5, 259.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 55.5, 313.0, 129.5, 313.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 231.5, 263.0, 55.5, 263.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 521.5, 143.0, 446.5, 143.0 ],
					"source" : [ "obj-22", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 494.5, 158.5, 494.0, 158.5 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 797.333313, 370.0, 737.333313, 370.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.gl.pixelate%.maxpat",
				"bootpath" : "/Users/delpozo/_Github/rdpozo_Modules/video/OpenGL/gl.pixelate/lib",
