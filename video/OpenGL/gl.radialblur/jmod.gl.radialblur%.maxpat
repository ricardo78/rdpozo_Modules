...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 588.333313, 203.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 588.333313, 235.0, 362.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.parameter vertical @range/bounds 0. 100. @type decimal @range/clipmode both @repetitions/allow 1 @ramp/drive scheduler @ramp/function linear @dataspace none @priority 3 @description \"set contrast ratio\"",
									"varname" : "avgluma[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 192.0, 229.0, 600.0, 33.0 ],
									"text" : "jcom.parameter horizontal @range/bounds 0. 100. @type decimal @range/clipmode both @repetitions/allow 1 @ramp/drive scheduler @ramp/function linear @dataspace none @priority 3 @description \"set contrast ratio\"",
									"varname" : "avgluma"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.parameter width @range/bounds 0. 100. @type decimal @range/clipmode both @repetitions/allow 1 @ramp/drive scheduler @ramp/function linear @dataspace none @priority 2 @description \"set contrast ratio\"",
									"varname" : "contrast"
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 469.0, 151.0, 122.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 458.5, 135.5, 581.5, 135.5 ],
					"source" : [ "obj-1", 0 ]
				}
