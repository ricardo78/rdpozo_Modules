...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 522.833313, 189.0, 389.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 26.0, 210.0, 345.0, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 97.0, 207.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 97.0, 142.0, 65.0, 20.0 ],
									"text" : "closebang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 97.0, 175.0, 32.5, 18.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 217.5, 373.5, 60.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 38.5, 93.849838, 41.0, 18.0 ],
									"text" : "Down:",
									"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 431.0, 367.0, 602.0, 33.0 ],
									"text" : "jcom.parameter slide/down @type decimal @range/bounds 0. 1000. @range/clipmode both @repetitions/allow 1 @ramp/drive scheduler @ramp/function linear @dataspace none @priority 2",
									"varname" : "feedback"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 434.0, 315.0, 596.0, 33.0 ],
									"text" : "jcom.parameter slide/up @type decimal @range/bounds 0. 1000. @range/clipmode both @repetitions/allow 1 @ramp/drive scheduler @ramp/function linear @dataspace none @priority 1",
									"varname" : "ekta"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 217.5, 294.0, 86.0, 30.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 5.0, 56.0, 95.5, 18.0 ],
									"text" : "Render context:",
									"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 217.5, 329.0, 60.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 38.5, 75.0, 39.0, 18.0 ],
									"text" : "up:",
									"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 371.5, 373.5, 50.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 371.5, 328.0, 50.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "A module for sliding image",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 417.0, 112.0, 97.0, 20.0 ],
					"text" : "jalg.gl.slide% #0"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 406.5, 96.5, 504.5, 96.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 717.333313, 371.0, 496.0, 371.0, 496.0, 166.0, 532.333313, 166.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.gl.slide%.maxpat",
				"bootpath" : "/Users/delpozo/_Github/rdpozo_Modules/video/OpenGL/gl.slide/lib",
