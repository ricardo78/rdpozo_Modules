...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 158.0, 511.0, 908.0, 20.0 ],
									"text" : "jcom.parameter width @type decimal @range/bounds 0. 4. @range/clipmode both @repetitions/allow 1 @ramp/drive scheduler @ramp/function linear @dataspace none",
									"varname" : "width"
								}
...
,
					"patching_rect" : [ 417.0, 295.0, 64.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"tags" : "",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 352.0, 101.0, 101.0, 20.0 ],
					"text" : "jalg.gl.sobel% #0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 16.0, 221.0, 307.0, 19.0 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 174.0, 336.0, 174.0, 336.0, 282.0, 471.5, 282.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 361.5, 90.0, 336.0, 90.0, 336.0, 282.0, 426.5, 282.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 341.5, 83.0, 443.5, 83.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 25.5, 259.0, 426.5, 259.0 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"name" : "jalg.gl.sobel%.maxpat",
				"bootpath" : "/Users/rdpozo/JamomaDev/rdp.modules/video/OpenGL/gl.sobel/lib",
				"patcherrelativepath" : "../gl.sobel/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
