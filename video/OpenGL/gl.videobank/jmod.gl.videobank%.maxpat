...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 465.0, 125.0, 437.0, 20.0 ],
					"text" : "jcom.return duration @type generic @repetitions/allow 1 @range/clipmode none",
					"varname" : "movie/info[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 350.958984, 359.0, 49.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 15.0, 44.958984, 359.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 41.0, 39.684937, 86.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 202.0, 86.0, 55.0, 20.0 ],
					"text" : "jcom.init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 113.0, 110.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 158.0, 183.0, 148.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 76.0, 188.0, 137.0, 18.0 ],
									"text" : "load all video to memory:",
									"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"disabled" : [ 0 ],
									"hint" : "Load all or part of the video into memory. 0 is part of video into memory, 1 is all frames into memory",
									"id" : "obj-15",
									"itemtype" : 1,
									"maxclass" : "radiogroup",
									"numinlets" : 1,
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 670.0, 748.0, 18.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 208.0, 187.0, 18.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 696.0, 747.0, 500.0, 20.0 ],
									"text" : "jcom.parameter loadToMemory @type boolean @range/clipmode none @repetitions/allow 1",
									"varname" : "loadToMemory"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 274.0, 187.0, 18.0, 18.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_type" : 3,
											"parameter_invisible" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 6.0, 189.431396, 148.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 230.0, 188.0, 49.0, 18.0 ],
									"text" : "unique:",
									"textcolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 741.0, 660.0, 154.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 138.0, 129.0, 206.0, 32.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 174.0, 245.684937, 86.0, 42.0 ],
									"presentation" : 1,
...
,
					"patching_rect" : [ 402.0, 280.0, 64.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"description" : "",
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 152.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 337.0, 125.0, 66.0, 20.0 ],
					"text" : "jcom.out 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0, 13.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 317.0, 42.0, 59.0, 20.0 ],
					"text" : "jcom.in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 337.0, 86.0, 127.0, 20.0 ],
					"text" : "jalg.gl.videobank% #0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 178.0, 131.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1.0, 206.0, 290.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1.0, 174.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.0, 251.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 445.0, 152.0, 446.0, 20.0 ],
					"text" : "jcom.return movieInfo @type generic @repetitions/allow 1 @range/clipmode none",
					"varname" : "movie/info"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 409.0, 184.0, 443.0, 20.0 ],
					"text" : "jcom.return loopnotify @type generic @range/clipmode none @repetitions/allow 1",
					"varname" : "loopnotify"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 9.5, 159.0, 321.0, 159.0, 321.0, 267.0, 456.5, 267.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 346.5, 75.0, 321.0, 75.0, 321.0, 267.0, 411.5, 267.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 326.5, 68.0, 454.5, 68.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 10.5, 252.0, 411.5, 252.0 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 211.5, 201.0, 10.5, 201.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-103::obj-15" : [ "radiogroup[1]", "radiogroup", 0 ]
		}
,
		"dependency_cache" : [ 			{
